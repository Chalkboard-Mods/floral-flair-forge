...
public class FloralBlocks {
    ...
    public static final RegistryObject<Block> POTTED_TWILIGHT_ORCHID = HELPER.createBlockNoItem("potted_twilight_orchid", () -> new FlowerPotBlock(TWILIGHT_ORCHID.get(), PropertyUtil.FLOWER_POT));
    public static final RegistryObject<Block> POTTED_SUNSET_ORCHID = HELPER.createBlockNoItem("potted_sunset_orchid", () -> new FlowerPotBlock(SUNSET_ORCHID.get(), PropertyUtil.FLOWER_POT));
    public static final RegistryObject<Block> POTTED_MORNING_ORCHID = HELPER.createBlockNoItem("potted_morning_orchid", () -> new FlowerPotBlock(MORNING_ORCHID.get(), PropertyUtil.FLOWER_POT));
    public static final RegistryObject<Block> POTTED_DAWN_ORCHID = HELPER.createBlockNoItem("potted_dawn_orchid", () -> new FlowerPotBlock(DAWN_ORCHID.get(), PropertyUtil.FLOWER_POT));
    public static final RegistryObject<Block> POTTED_PINK_HYACINTH = HELPER.createBlockNoItem("potted_pink_hyacinth", () -> new FlowerPotBlock(PINK_HYACINTH.get(), PropertyUtil.FLOWER_POT));
    public static final RegistryObject<Block> POTTED_BLUE_HYACINTH = HELPER.createBlockNoItem("potted_blue_hyacinth", () -> new FlowerPotBlock(BLUE_HYACINTH.get(), PropertyUtil.FLOWER_POT));
    public static final RegistryObject<Block> POTTED_YELLOW_HYACINTH = HELPER.createBlockNoItem("potted_yellow_hyacinth", () -> new FlowerPotBlock(YELLOW_HYACINTH.get(), PropertyUtil.FLOWER_POT));
    public static final RegistryObject<Block> POTTED_BLACK_HYACINTH = HELPER.createBlockNoItem("potted_black_hyacinth", () -> new FlowerPotBlock(BLACK_HYACINTH.get(), PropertyUtil.FLOWER_POT));
    ...
    public static final RegistryObject<Block> POTTED_MUSCARI = HELPER.createBlockNoItem("potted_muscari", () -> new FlowerPotBlock(MUSCARI.get(), PropertyUtil.FLOWER_POT));
